...
for x in range(3001,6001):
    ...
    output, file1_split_output, error = get_md5sum(file_path)
    trunc_file_md5 = str(file1_split_output[0])
    ...
    read_output, file2_split_output, read_error = get_md5sum(file_path)
    read_trunc_file_md5 = str(file2_split_output[0])
...
for y in range(3001,6001):
    ...
    output, file3_split_output, error = get_md5sum(file_path)
    trunc_append_file_md5 = str(file3_split_output[0])
    ...
    read_output, file4_split_output, read_error = get_md5sum(file_path)
    read_trunc_append_file_md5 = str(file4_split_output[0])
...
for i in range(len(bs)):
    for j in range(3001,6001):
        ...
        output, file5_split_output, error = get_md5sum(file_path)
        Overwrite_trunc_file_md5 = str(file5_split_output[0])
        ...
        read_output, file6_split_output, read_error = get_md5sum(file_path)
        read_overwrite_trunc_file_md5 = str(file6_split_output[0])
